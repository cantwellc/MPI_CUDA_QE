...
\node [circle,draw] (z){\vphantom{A}}
  child {node [circle,draw] (a) {\vphantom{A}}
  	child {node [circle,draw] (b) {\vphantom{A}}
  	}
  ...
  child {node [circle,draw] (f) {\vphantom{A}}
  	child {node [circle,draw] (g) {\vphantom{A}}
  	}
  	child {node [circle,draw] (h) {\vphantom{A}}
  	}
  	child {node [circle,draw] (i) {\vphantom{A}}
  	}
  	child {node [circle,draw] (j) {\vphantom{A}}
  	}
  }
  child {node [circle,draw] (k) {\vphantom{A}}
  	child {node [circle,draw] (l) {\vphantom{A}}
  	}
  	child {node [circle,draw] (m) {\vphantom{A}}
  	}
  	child {node [circle,draw] (n) {\vphantom{A}}
  	}
  	child {node [circle,draw] (o) {\vphantom{A}}
  	}
  }
  child {node [circle,draw] (p) {\vphantom{A}}
  	child {node [circle,draw] (q) {\vphantom{A}}
  	}
  	child {node [circle,draw] (r) {\vphantom{A}}
  	}
  	child {node [circle,draw] (s) {\vphantom{A}}
  	}
  	child {node [circle,draw] (t) {\vphantom{A}}
  	}
  };
%   child {node [circle,draw] (j) {\vphantom{A}}
%     child {node [circle,draw] (k) {\vphantom{A}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Out MCQE algorithm does not use any approximation methods so the result should be exact up to float precision.  The following plot was obtained using a sequential algorithm with CUDA.  We expect for the same input MCQE would produce the same.
